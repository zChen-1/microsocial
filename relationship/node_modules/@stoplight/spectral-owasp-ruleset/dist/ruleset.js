...
var ruleset_default = {
  ...
  rules: {
    ...
    "owasp:api4:2019-string-restricted": {
      ...
      description: "To avoid unexpected values being sent or leaked, ensure that strings have either a format or a RegEx pattern. This can be done using `format`, `pattern`, `enum` or `const`.",
      severity: DiagnosticSeverity.Error,
      given: "#StringProperties",
      then: {
        function: import_spectral_functions.schema,
